...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 28 2018 г., 09:38
...
(6, 'У группы Papa Roach вышли две новых песни', 'Группа <i>Papa Roach</i> выпустила две новых песни. ', 'У этих песен довольно схожие обложки, и сам эти песни сделаны в похожих стилях. Скорее всего, они собираются выпускать альбом. <i>Ждём...</i>', 'cover.jpg', 0, '2018-11-28'),
(7, 'Группа \"Порнофильмы\" исполнила новую песню на телешоу \"Вечерний Ургант\"', 'Группа <i>\"Порнофильмы\"</i> исполнила ранее неизданную песню <i>\"Ритуалы\"</i>.', 'Возможно, эта песня из нового альбома. Ребята готовят новый альбом, выступают на первом. Ждём новый альбом, он будет жарким!', 'coverуцй.jpg', 0, '2018-11-28');
...
--
ALTER TABLE `fy_news`
  MODIFY `fy_news_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
